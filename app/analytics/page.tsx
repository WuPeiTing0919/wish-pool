        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="text-center mb-8 md:mb-12">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white">問題洞察分析</h2>
              <Badge className="bg-gradient-to-r from-pink-500/20 to-purple-500/20 text-pink-200 border border-pink-400/30 px-3 py-1">
                完整數據分析
              </Badge>
            </div>
            <p className="text-blue-200 text-lg">深入分析職場困擾的分布和趨勢</p>
            <p className="text-blue-300 text-sm mt-2">包含所有提交的案例數據，協助管理者了解真實狀況</p>
          </div>
            ...
            <CardContent>
              <div className="grid sm:grid-cols-2 gap-4 text-sm">
                <div className="space-y-2">
                  ...
                  <p className="text-indigo-100">這些案例會顯示在「聆聽心聲」頁面，供其他人查看和產生共鳴</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-semibold text-indigo-200 flex items-center gap-2">
                  ...
                  <p className="text-indigo-100">這些案例保持匿名且私密，僅用於統計分析，幫助了解整體趨勢</p>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <div className="flex items-center gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    <CardTitle className="text-lg sm:text-xl md:text-2xl text-white">問題分類說明</CardTitle>
                    <CardDescription className="text-indigo-200 text-sm sm:text-base">
                      了解我們如何分類和分析各種職場困擾
                    </CardDescription>
                  </div>
          ...
          <div className="space-y-8 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-8 md:gap-12">
            ...
            <Card className="bg-slate-800/50 backdrop-blur-sm border border-slate-600/50">
              <CardHeader>
                ...
                <CardDescription className="text-blue-200">各類職場困擾的完整案例分布（包含私密數據）</CardDescription>
              </CardHeader>
              <CardContent>
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-slate-300">{category.count} 個案例</div>
          ...
          <Card className="bg-gradient-to-r from-purple-800/30 to-indigo-800/30 backdrop-blur-sm border border-purple-600/50 mt-8 md:mt-12">
            <CardHeader>
              ...
              <CardDescription className="text-purple-200">包含私密案例的全面分析，提供更準確的洞察</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid sm:grid-cols-2 gap-4 text-sm">
                <div className="space-y-2">
                  <h4 className="font-semibold text-purple-200">🔍 真實全貌</h4>
                  <p className="text-purple-100">包含所有案例數據，不受公開意願影響，呈現最真實的問題狀況</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-semibold text-purple-200">📊 精準決策</h4>
                  <p className="text-purple-100">基於完整數據制定改善策略，避免因樣本偏差導致的決策失誤</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-semibold text-purple-200">🎯 隱藏問題</h4>
                  <p className="text-purple-100">發現那些員工不願公開但確實存在的問題，提前預防和解決</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-semibold text-purple-200">🔒 隱私保護</h4>
                  <p className="text-purple-100">在保護個人隱私的前提下，最大化數據的分析價值</p>
                </div>
              </div>
            </CardContent>
          </Card>
